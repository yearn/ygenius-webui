  ...
  const generateResponse = (question, _questions, _answers) => {
    ...
    .then((data) => {
      setAnswers(() => [..._answers, data.substring(1, data.length - 2)
        .replace(/\\n/g, '\n')
        // .replaceAll("\\u00c0", "À").replaceAll("\\u00c1", "Á").replaceAll("\\u00c2", "Â").replaceAll("\\u00c3", "Ã").replaceAll("\\u00c4", "Ä").replaceAll("\\u00c5", "Å").replaceAll("\\u00c6", "Æ").replaceAll("\\u00c7", "Ç").replaceAll("\\u00c8", "È").replaceAll("\\u00c9", "É").replaceAll("\\u00ca", "Ê").replaceAll("\\u00cb", "Ë").replaceAll("\\u00cc", "Ì").replaceAll("\\u00cd", "Í").replaceAll("\\u00ce", "Î").replaceAll("\\u00cf", "Ï").replaceAll("\\u00d0", "Ð").replaceAll("\\u00d1", "Ñ").replaceAll("\\u00d2", "Ò").replaceAll("\\u00d3", "Ó").replaceAll("\\u00d4", "Ô").replaceAll("\\u00d5", "Õ").replaceAll("\\u00d6", "Ö").replaceAll("\\u00d8", "Ø").replaceAll("\\u00d9", "Ù").replaceAll("\\u00da", "Ú").replaceAll("\\u00db", "Û").replaceAll("\\u00dc", "Ü").replaceAll("\\u00dd", "Ý").replaceAll("\\u00df", "ß").replaceAll("\\u00e0", "à").replaceAll("\\u00e1", "á").replaceAll("\\u00e2", "â").replaceAll("\\u00e3", "ã").replaceAll("\\u00e4", "ä").replaceAll("\\u00e5", "å").replaceAll("\\u00e6", "æ").replaceAll("\\u00e7", "ç").replaceAll("\\u00e8", "è").replaceAll("\\u00e9", "é").replaceAll("\\u00ea", "ê").replaceAll("\\u00eb", "ë").replaceAll("\\u00ec", "ì").replaceAll("\\u00ed", "í").replaceAll("\\u00ee", "î").replaceAll("\\u00ef", "ï").replaceAll("\\u00f0", "ð").replaceAll("\\u00f1", "ñ").replaceAll("\\u00f2", "ò").replaceAll("\\u00f3", "ó").replaceAll("\\u00f4", "ô").replaceAll("\\u00f5", "õ").replaceAll("\\u00f6", "ö").replaceAll("\\u00f8", "ø").replaceAll("\\u00f9", "ù").replaceAll("\\u00fa", "ú").replaceAll("\\u00fb", "û").replaceAll("\\u00fc", "ü").replaceAll("\\u00fd", "ý").replaceAll("\\u00ff", "ÿ").replaceAll("\\u00de", "Þ").replaceAll("\\u00fe", "þ")
        .replaceAll("\u0410", "А").replaceAll("\u0411", "Б").replaceAll("\u0412", "В").replaceAll("\u0413", "Г").replaceAll("\u0414", "Д").replaceAll("\u0415", "Е").replaceAll("\u0401", "Ё").replaceAll("\u0416", "Ж").replaceAll("\u0417", "З").replaceAll("\u0418", "И").replaceAll("\u0419", "Й").replaceAll("\u041a", "К").replaceAll("\u041b", "Л").replaceAll("\u041c", "М").replaceAll("\u041d", "Н").replaceAll("\u041e", "О").replaceAll("\u041f", "П").replaceAll("\u0420", "Р").replaceAll("\u0421", "С").replaceAll("\u0422", "Т").replaceAll("\u0423", "У").replaceAll("\u0424", "Ф").replaceAll("\u0425", "Х").replaceAll("\u0426", "Ц").replaceAll("\u0427", "Ч").replaceAll("\u0428", "Ш").replaceAll("\u0429", "Щ").replaceAll("\u042a", "Ъ").replaceAll("\u042b", "Ы").replaceAll("\u042c", "Ь").replaceAll("\u042d", "Э").replaceAll("\u042e", "Ю").replaceAll("\u042f", "Я").replaceAll("\u00c0", "À").replaceAll("\u00c1", "Á").replaceAll("\u00c2", "Â").replaceAll("\u00c3", "Ã").replaceAll("\u00c4", "Ä").replaceAll("\u00c5", "Å").replaceAll("\u00c6", "Æ").replaceAll("\u00c7", "Ç").replaceAll("\u00c8", "È").replaceAll("\u00c9", "É").replaceAll("\u00ca", "Ê").replaceAll("\u00cb", "Ë").replaceAll("\u00cc", "Ì").replaceAll("\u00cd", "Í").replaceAll("\u00ce", "Î").replaceAll("\u00cf", "Ï").replaceAll("\u00d0", "Ð").replaceAll("\u00d1", "Ñ").replaceAll("\u00d2", "Ò").replaceAll("\u00d3", "Ó").replaceAll("\u00d4", "Ô").replaceAll("\u00d5", "Õ").replaceAll("\u00d6", "Ö").replaceAll("\u00d8", "Ø").replaceAll("\u00d9", "Ù").replaceAll("\u00da", "Ú").replaceAll("\u00db", "Û").replaceAll("\u00dc", "Ü").replaceAll("\u00dd", "Ý").replaceAll("\u00df", "ß").replaceAll("\u00e0", "à").replaceAll("\u00e1", "á").replaceAll("\u00e2", "â").replaceAll("\u00e3", "ã").replaceAll("\u00e4", "ä").replaceAll("\u00e5", "å").replaceAll("\u00e6", "æ").replaceAll("\u00e7", "ç").replaceAll("\u00e8", "è").replaceAll("\u00e9", "é").replaceAll("\u00ea", "ê").replaceAll("\u00eb", "ë").replaceAll("\u00ec", "ì").replaceAll("\u00ed", "í").replaceAll("\u00ee", "î").replaceAll("\u00ef", "ï").replaceAll("\u00f0", "ð").replaceAll("\u00f1", "ñ").replaceAll("\u00f2", "ò").replaceAll("\u00f3", "ó").replaceAll("\u00f4", "ô").replaceAll("\u00f5", "õ").replaceAll("\u00f6", "ö").replaceAll("\u00f8", "ø").replaceAll("\u00f9", "ù").replaceAll("\u00fa", "ú").replaceAll("\u00fb", "û").replaceAll("\u00fc", "ü").replaceAll("\u00fd", "ý").replaceAll("\u00ff", "ÿ")
        .replaceAll("\\u2019","'")])
      setIsLoading(() => false)
    });
    setInput(() => '')
